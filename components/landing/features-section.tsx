...
const features = [
  {
    ...
    description: "Before writing code or filming a frame, we map out a custom digital blueprint perfectly aligned with your core business objectives.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Flawless Execution",
    description: "Our team builds, automates, and produces your assets in house, ensuring absolute quality control and striking design at every stage.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Seamless Deployment",
    description: "We handle the entire launch process, integrating your new systems securely without disrupting your day to day operations.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Data Driven Scaling",
    description: "Post launch, we leverage targeted social strategies and continuous optimization to drive traffic, increase conversions, and scale your brand.",
    visual: "security",
  },
];
...
const aiOrbitNodes = [
  { x: 150, y: 80, delay: 0 },
  { x: 125, y: 123.3, delay: 0.3 },
  { x: 75, y: 123.3, delay: 0.6 },
  { x: 50, y: 80, delay: 0.9 },
  { x: 75, y: 36.7, delay: 1.2 },
  { x: 125, y: 36.7, delay: 1.5 },
];
